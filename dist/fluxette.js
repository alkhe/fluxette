			...
			return function (Component) {
				return (function (_Component) {
					...
					function _class() {
						...
						var ls = specifier(state());
						// Ensure the same reference of setState
						var listener = this[_util.listenerKey] = function (data) {
							var ns = specifier(data);
							(0, _chai.expect)(ns).to.deep.equal(ls);
							console.log(ns, ls);
							ls = ns;
							_get(Object.getPrototypeOf(_class.prototype), 'setState', _this).call(_this, ns);
						};
						// Register setState
						hooks.push(listener);
					}
...
},{"./store":41,"./util":42,"chai":5,"react":"react"}],41:[function(require,module,exports){
"use strict";
...
},{"../vendor/lodash":43}],43:[function(require,module,exports){
(function (global){
/**
 * @license
